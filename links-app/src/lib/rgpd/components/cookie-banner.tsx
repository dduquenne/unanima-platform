...
const COOKIE_CONSENT_KEY = 'links_cookie_consent'
const SESSION_ID_KEY = 'links_session_id'
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="rounded-[var(--radius-md,0.5rem)] border border-[var(--color-border)] px-4 py-2 text-sm font-medium text-[var(--color-text)] hover:bg-[var(--color-surface-hover,var(--color-background))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 transition-colors duration-150"
          >
            Refuser
          </button>
          <button
            onClick={handleAccept}
            className="rounded-[var(--radius-md,0.5rem)] bg-[var(--color-primary)] px-4 py-2 text-sm font-medium text-[var(--color-text-inverse,#fff)] hover:bg-[var(--color-primary-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 transition-colors duration-150"
          >
            Accepter
          </button>
        </div>
