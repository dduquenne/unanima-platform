...
|-------|-------|-------|----------|-------|-------|--------|
| 1 | #210 | MAQ-02 — Dashboard bénéficiaire | 🟢 Feature | 1 | ergonomix | ⬜ À faire |
| 2 | #211 | MAQ-03 — Saisie de phase (réponses questionnaire) | 🟢 Feature | 1 | ergonomix | ⬜ À faire |
| 3 | #212 | MAQ-12 — Documents par phase (vue bénéficiaire) | 🟢 Feature | 1 | ergonomix | ⬜ À faire |
| 4 | #213 | MAQ-14 — Profil utilisateur | 🟢 Feature | 2 | ergonomix | ⬜ À faire |
| 5 | #214 | MAQ-15 — Mes données RGPD | 🟢 Feature | 2 | ergonomix | ⬜ À faire |
...
- **#211** : Saisie de phase — autosave, validation, compteur questions (L)
